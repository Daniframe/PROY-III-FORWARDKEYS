...
datasett$data_attack = data_attack[data_attack$bookingdate %in% sort(unique(data_attack$bookingdate))[substring(sort(unique(data_attack$bookingdate)),6) %in% substring(sort(unique(data_compare$bookingdate)),6)], ]  

updateProgressBar(session = session, id = "startpb", value = 90)

datasett$data_compare = data_compare[data_compare$bookingdate %in% sort(unique(data_compare$bookingdate))[substring(sort(unique(data_compare$bookingdate)),6) %in% substring(sort(unique(data_attack$bookingdate)),6)], ]  
...
data_attack =  datasett$data_attack
data_compare = datasett$data_compare
